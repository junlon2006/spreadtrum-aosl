...
> **⚠️ 注意：此仓库为示例工程，仅展示 AOSL 在展锐 RTOS 平台的集成方式。当前示例对应 AOSL 官方仓库 commit [`7865962`](https://github.com/AgoraIO-Community/aosl/commit/7865962fc39ea180f290d3a7d220a85f07e1ec52)，AOSL 代码请以[官方最新版本](https://github.com/AgoraIO-Community/aosl)为准。**
