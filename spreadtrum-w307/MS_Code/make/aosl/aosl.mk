...
MCFLAG_OPT += -std=gnu99 -DCONFIG_AOSL_IPV6
...
MINCPATH += \
    ...
    MS_MMI_Main/source/mmi_app/app/aosl/platform/src/spreadtrum-w307/config
...
#
# AOSL platform adaptation for spreadtrum-w307 (ThreadX/SCI API)
#
MSRCPATH += MS_MMI_Main/source/mmi_app/app/aosl/platform/src/spreadtrum-w307
